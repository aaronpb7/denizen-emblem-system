...
triton_key_usage:
    ...
    events:
        ...
        - if <proc[is_wearing_divine_armor].context[<player>|triton]>:
            - if <[tier]> == OLYMPIAN:
                - flag player triton.pity_counter:0
            - else:
                - flag player triton.pity_counter:++
...
roll_triton_tier:
    ...
    - if <proc[is_wearing_divine_armor].context[<player>|triton]>:
        - if <player.flag[triton.pity_counter].if_null[0]> >= 49:
