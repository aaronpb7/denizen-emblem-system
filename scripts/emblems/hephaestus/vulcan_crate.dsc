...
vulcan_crate_animation:
    ...
    - narrate "<&7>You unlock the <&b>Vulcan Vault<&7>..."
...
roll_vulcan_outcome:
    ...
    - if !<player.has_flag[vulcan.item.shulker]>:
        - define all_obtained false
    - if !<player.has_flag[vulcan.item.charm]>:
        - define all_obtained false
    ...
    - choose <[chosen]>:
        - case pickaxe:
            - define result_map <map[type=UNIQUE;item_id=pickaxe;item=<item[vulcan_pickaxe]>;display=Vulcan Pickaxe]>
        - case title:
        ...
        - case charm:
            - define result_map <map[type=UNIQUE;item_id=charm;item=<item[vulcan_forge_charm]>;display=Vulcan Forge Charm]>
    ...
    - choose <[result].get[type]>:
        ...
        - case UNIQUE:
            ...
            - choose <[item_id]>:
                ...
                - case charm:
                    - give vulcan_forge_charm
                    - flag player vulcan.item.charm:true
