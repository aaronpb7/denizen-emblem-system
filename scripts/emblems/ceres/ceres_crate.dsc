...
ceres_crate_animation:
    ...
    - define border <item[cyan_stained_glass_pane].with[display_name=<&b>]>
    ...
    - define preview_pool <list[enchanted_golden_apple|gray_dye|enchanted_golden_apple|gray_dye|enchanted_golden_apple|gray_dye]>
    ...
    - if <[slot1].material.name> == gray_dye:
        - define slot1 <[slot1].with[display_name=<&8>???]>
    - if <[slot2].material.name> == gray_dye:
        - define slot2 <[slot2].with[display_name=<&8>???]>
    - if <[slot3].material.name> == gray_dye:
        - define slot3 <[slot3].with[display_name=<&8>???]>
    - if <[slot4].material.name> == gray_dye:
        - define slot4 <[slot4].with[display_name=<&8>???]>
    - if <[slot5].material.name> == gray_dye:
        - define slot5 <[slot5].with[display_name=<&8>???]>
    ...
    - repeat 20:
        ...
        - define slot3 <[slot4]>
        - define slot4 <[slot5]>
        - define new_item <item[<[preview_pool].random>]>
        - if <[new_item].material.name> == gray_dye:
            - define slot5 <[new_item].with[display_name=<&8>???]>
        - else:
...
ceres_crate_early_close:
    ...
    events:
        ...
        - queue stop ceres_crate_<player.uuid>
